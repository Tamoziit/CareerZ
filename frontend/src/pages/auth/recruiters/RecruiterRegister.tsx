...
import useRecruiterSignup from "../../../hooks/useRecruiterSignup";
...
const RecruiterRegister = () => {
  ...
  const { recruiterSignup, loading } = useRecruiterSignup();
      ...
      <div className="flex w-full items-center justify-center">
        <div className="flex overflow-hidden">
          ...
          <form className="flex flex-col gap-4 items-start justify-center glassmorphic p-4 w-[320px] md:w-[380px] lg:w-[450px]" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col gap-1 w-full">
              <label className="text-lg font-medium text-gray-300">Admin Email</label>
              <input
                type="email"
            ...
            <div className="flex flex-col gap-1 w-full">
              <label className="text-lg font-medium text-gray-300">Public Email</label>
              <input
                type="email"
                placeholder="Enter your Email"
                required
            ...
            <div className="flex flex-col gap-1 w-full">
              <label className="text-lg font-medium text-gray-300">Official Website</label>
              <input
                type="text"
                placeholder="Enter your company's official website link"
                required
                className="input-primary"
            ...
            <div className="flex -mt-5 -mb-0.5 w-full items-center justify-center">
              <Link to="/recruiter/login" className="text-gray-400 hover:text-blue-600">Already have an Account? Login</Link>
            </div>
          </form>
        </div>
      </div>
